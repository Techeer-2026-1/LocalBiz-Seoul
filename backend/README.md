...
| 서비스 | 호스트 | 용도 |
|--------|--------|------|
| Cloud SQL (PostgreSQL+PostGIS) | REDACTED_DB_HOST:5432 | 정형 데이터 (266만건 places, 7천건 events) |
| OpenSearch 2.17 (GCE) | REDACTED_OS_HOST:9200 | 벡터 검색 (nori 한국어 분석기, 768d) |
| OpenSearch Dashboards | REDACTED_OS_HOST:5601 | 데이터 조회 UI |
